...
xst -ifn xst.scr
move dcm_base_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\dcm_base_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc dcm_base_exdes.ucf dcm_base_exdes

echo 'Running map'
map -timing -pr b dcm_base_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm dcm_base_exdes -w routed.ncd routed.vhd
cd ..
